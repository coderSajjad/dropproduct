...
Upload product images by dragging them onto the DropProduct page. Each image automatically becomes a WooCommerce product — no forms, no manual data entry needed.
...
3. Drag them onto the **dropzone area** on the DropProduct page
