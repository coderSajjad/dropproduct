# Getting Started with WooUpload

Welcome to **WooUpload** — the fastest way to create WooCommerce products from images.

---

## What Does It Do?

Instead of creating products one at a time in WooCommerce, WooUpload lets you:
...
1. Upload the `woocommerce-uploady` folder to `/wp-content/plugins/`
2. Go to **Plugins** in your WordPress admin
3. Click **Activate** on **WooUpload**
4. Visit **WooUpload** in the admin sidebar

---

## Quick Start Guide

### Step 1: Open WooUpload
Click **WooUpload** in the WordPress admin sidebar. You'll see the dropzone and an empty product grid.
...
The free version supports **simple products only**. For advanced features, check out [WooUpload Pro](https://WooUpload.dev/pro):
